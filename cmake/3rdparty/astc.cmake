...
foreach(ASTC_SOURCE IN LISTS ASTC_SOURCES)
	if(MSVC)
		set_source_files_properties(${ASTC_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${ASTC_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
