...
foreach(GLSLANG_SOURCE IN LISTS GLSLANG_SOURCES)
	if(MSVC)
		set_source_files_properties(${GLSLANG_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${GLSLANG_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
