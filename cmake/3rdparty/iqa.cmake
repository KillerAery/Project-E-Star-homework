...
foreach(IQA_SOURCE IN LISTS IQA_SOURCES)
	if(MSVC)
		set_source_files_properties(${IQA_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${IQA_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
