...
foreach(SQUISH_SOURCE IN LISTS SQUISH_SOURCES)
	if(MSVC)
		set_source_files_properties(${SQUISH_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${SQUISH_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
