...
foreach(MESHOPTIMIZER_SOURCE IN LISTS MESHOPTIMIZER_SOURCES)
	if(MSVC)
		set_source_files_properties(${MESHOPTIMIZER_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${MESHOPTIMIZER_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
