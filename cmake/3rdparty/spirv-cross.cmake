...
foreach(SPIRV_CROSS_SOURCE IN LISTS SPIRV_CROSS_SOURCES)
	if(MSVC)
		set_source_files_properties(${SPIRV_CROSS_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${SPIRV_CROSS_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
