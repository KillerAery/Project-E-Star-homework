...
foreach(SPIRV_TOOLS_SOURCE IN LISTS SPIRV_TOOLS_SOURCES)
	if(MSVC)
		set_source_files_properties(${SPIRV_TOOLS_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${SPIRV_TOOLS_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
