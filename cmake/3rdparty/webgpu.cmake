...
foreach(WEBGPU_SOURCE IN LISTS WEBGPU_SOURCES)
	if(MSVC)
		set_source_files_properties(${WEBGPU_SOURCE} PROPERTIES COMPILE_FLAGS "/W0" )
	else()
		set_source_files_properties(${WEBGPU_SOURCE} PROPERTIES COMPILE_FLAGS "-w" )
	endif()
endforeach()
