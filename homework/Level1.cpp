...
Level1::PosColorVertex Level1::s_cubeVertices[] =
{
...
const uint16_t Level1::s_cubeTriList[] =
{
	0, 1, 2, // 0
	1, 3, 2,
	4, 6, 5, // 2
...
void Level1::init(int32_t _argc, const char* const* _argv, uint32_t _width, uint32_t _height)
{
